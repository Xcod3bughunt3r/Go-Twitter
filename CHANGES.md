...
* Add Go module support ([#143](https://github.com/Xcod3bughunt3r/Go-Twitter/pull/143))

## 11/2018

* Add `DirectMessageService` support for the new Twitter Direct Message Events [API](https://developer.twitter.com/en/docs/direct-messages/api-features) ([#125](https://github.com/Xcod3bughunt3r/Go-Twitter/pull/125))
